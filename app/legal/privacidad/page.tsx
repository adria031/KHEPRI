...
export default function Privacidad() {
  return (
    <LegalLayout title="Política de Privacidad" updated="4 de junio de 2026">
      ...
      <div className="lg-section">
        <h2>8. Cookies</h2>
        <p>Utilizamos cookies propias y de terceros. Consulta nuestra <a href="/legal/cookies">Política de Cookies</a> para más información.</p>
      </div>
