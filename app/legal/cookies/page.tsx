...
export default function Cookies() {
  return (
    <LegalLayout title="Política de Cookies" updated="4 de junio de 2026">
      ...
      <div className="lg-section">
        ...
        <p>La primera vez que visitas Khepria aparece un banner de cookies. Puedes elegir entre:</p>
        <ul>
          <li><strong>Aceptar todas:</strong> consientes el uso de cookies necesarias, analíticas y de funcionalidad.</li>
          <li><strong>Solo necesarias:</strong> solo se activarán las cookies imprescindibles para el funcionamiento del servicio.</li>
          <li><strong>Configurar:</strong> elige individualmente qué tipos de cookies aceptas.</li>
        </ul>
        <p>Tu preferencia se guarda en <code>localStorage</code> bajo la clave <code>khepria_cookies_consent</code> y no volvemos a mostrarte el banner hasta que borres los datos de navegación.</p>
      </div>
