...
export default function Terminos() {
  return (
    <LegalLayout title="Términos y Condiciones" updated="4 de junio de 2026">
      ...
      <div className="lg-section">
        ...
        <p>El tratamiento de datos personales se rige por nuestra <a href="/legal/privacidad">Política de Privacidad</a>. Para los datos de clientes y trabajadores que introduces en Khepria, actúas como responsable del tratamiento y Khepria como encargado, de acuerdo con el RGPD.</p>
      </div>
      ...
      <div className="lg-section">
        ...
        <p>Estos términos se rigen por la legislación española. Para cualquier controversia, las partes se someten a los juzgados y tribunales competentes de España, salvo que la normativa de protección de consumidores establezca otro fuero.</p>
